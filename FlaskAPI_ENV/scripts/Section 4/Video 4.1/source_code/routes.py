...
def init_api_routes(app):
    if app:
        ...
        app.add_url_rule('/api/candidate/<string:id>', 'update_candidate', update_candidate, methods=['PUT'])
        ...
        app.add_url_rule('/api/candidate/random/<int:nr_of_items>', 'get_random_candidates', random_candidates,
                         methods=['GET'])
        app.add_url_rule('/api/candidate/<string:id>', 'delete_candidate', delete_candidate, methods=['DELETE'])
