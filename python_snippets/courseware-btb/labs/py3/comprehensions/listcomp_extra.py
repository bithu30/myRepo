...
Create a new list comprehension called "combo", which is constructed from
"colors" and "garments".
...
colors = ['aquamarine', 'orange', 'teal', 'cyan']
garments = ['hat', 'belt', 'bell bottoms', 'cape', 'trench coat']
garment_filter=['hat','belt','cape']

combos=[ color+' '+garment for color in colors for garment in garments]
brief_combos=[ color+' '+garment for color in colors for garment in garments if garment in garment_filter]
