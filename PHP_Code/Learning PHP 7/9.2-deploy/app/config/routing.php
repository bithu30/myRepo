...
$stat = function (Request $request, Silex\Application $app) {
    $app['stat']->saveStat();
};

$app->get('/', "homepage.controller:indexAction")->bind('home')->before($userAuth)->before($stat);
...
$app->get('/rss', "rss_feed.controller:indexAction");
...
$app->post('/admin/comments/', "admin_comments.controller:listAction")->bind('admin_comment_list')->before($adminAuth);
$app->post('/admin/comments/delete', "admin_comments.controller:deleteAction")->bind('admin_comment_delete')->before($adminAuth);

$app->get('/admin/stats', "admin_stats.controller:indexAction")->bind('admin_stats')->before($adminAuth);